   ...
   <nav class="navbar navbar-default navbar-static-top navs">
      <div class="container">
        <div class=" navbar-header">
         ...
         <div class="col-md-3 logo"><a href="<?php echo e(url('/home')); ?>"><img src="images/logo.png"></a></div>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
        <nav class="col-md-3 navicon">
              <ul>
                  <li><i class="glyphicon glyphicon-user"></i></li>
                   <li><i class="glyphicon glyphicon-comment naviconactive"><span class="badge">4</span></i></li>
