             ...
             <div class="row">
              ...
              <nav class="row sidebar-menus">
                  <ul>
                        ...
                        <a href="<?php echo e(url('/portfolio')); ?>"><li class="menuactive"><span class="glyphicon glyphicon-send">&nbsp;</span>Portfolio</li></a>
...
<section  class="col-md-12 content-portfolio"> 
    <nav class="col-md-12">
        <ul>
           ...
           <?php foreach($userPorfoliosCategories as $userCategories): ?>
             <li><a href="#tab<?php echo e($userCategories->id); ?>" role="tab" data-toggle="tab"><?php echo e($userCategories->title); ?></a></li>
           <?php endforeach; ?>
        </ul>
    </nav>
    ...
    <section  class="tab-content">
        ...
        <section role="tabpanel" class="tab-pane active" id="tab0">
               <?php foreach($userPorfolios as $userPorfolio): ?>
                    <div class="col-md-4" data-toggle="modal" data-target="#all_<?php echo e($userPorfolio->id); ?>">
                        <center>
                 ...
                 <?php $fileName = "upload/".$userPorfolio->post_thumbnail;
                    if(file_exists($fileName)){  ?>
                             <img src="upload/<?php echo e($userPorfolio->post_thumbnail); ?>" class="img-responsive">
                 <?php }else{ ?>
                 ...
                 <?php } ?>      
                          ...
                          <div class="ro$fileNamew">
                            <?php echo e($userPorfolio->port_title); ?>
                  ...
                  <!-- Modal for All_PorfolioCategory -->
                          <section>
                                    <div class="modal fade" id="all_<?php echo e($userPorfolio->id); ?>" role="dialog">
                                            ...
                                            <!-- Modal content-->
                                              <div class="modal-content">
                                                    ...
                                                    <div class="col-md-12 content-panel-header">
                                                        ...
                                                        <center>
                                                         <h4><?php echo e($userPorfolio->port_title); ?></h4>
                                                          <?php $fileName = "upload/".$userPorfolio->post_thumbnail;
                                                              if(file_exists($fileName)){  ?>
                                                                       <img src="upload/<?php echo e($userPorfolio->post_thumbnail); ?>" class="img-responsive">
                                                           <?php }else{ ?>
                                                                        <img src="images/portfolio_images.png" class="img-responsive"> 
                                                           <?php } ?> 
                                                          <p class="text-center"><?php echo e($userPorfolio->port_excerpt); ?></p>   
                                                        </center>
                                                    </div>
                                              </div>
     ...
     <?php foreach ($userPorfoliosCategories as $userCategories) { ?>
        ...
        <section role="tabpanel" class="tab-pane" id="tab<?php echo e($userCategories->id); ?>">
         ...
         ?>
          ...
          <?php  foreach ($portfolioCat as $category) { ?>
              <div class="col-md-4" data-toggle="modal" data-target="#cat_<?php echo e($category->id); ?>">
                        <center>
                        <div class="portfolio-details form-group hvr-float-shadow">
                          <?php $fileName = "upload/".$category->post_thumbnail;
                            if(file_exists($fileName)){  ?>
                            <img src="upload/<?php echo e($category->post_thumbnail); ?>" class="img-responsive">
                              <?php }else{ ?>
                            <img src="images/portfolio_images.png" class="img-responsive"> 
               ...
               <!-- Modal for PorfolioCategory -->
                          <section>
                                    <div class="modal fade" id="cat_<?php echo e($category->id); ?>" role="dialog">
                                      <div class="modal-dialog">
                                            <!-- Modal content-->
                                              <div class="modal-content">
                                                    ...
                                                    <div class="col-md-12 content-panel-header">
                                                        ...
                                                        <center>
                                                         <h4><?php echo e($category->port_title); ?></h4>
                                                          <?php $fileName = "upload/".$category->post_thumbnail;
                                                          if(file_exists($fileName)){  ?>
                                                          <img src="upload/<?php echo e($category->post_thumbnail); ?>" class="img-responsive">
                                                            <?php }else{ ?>
                                                          ...
                                                          <?php } ?>
                                                          <p class="text-center"><?php echo e($category->port_excerpt); ?></p>   
                                                        </center>
                                                    </div>
                                              </div>
                                             ...
                                             <div class="form-group form-group">
                                              <div class="col-md-offset-1 col-sm-10">
                                                <select class="form-control" name="category_id">
                                                    <?php foreach($userPorfoliosCategories as $userCategories): ?>
                                                     <option value="<?php echo e($userCategories->id); ?>"><?php echo e($userCategories->title); ?></option>
                                                   <?php endforeach; ?>
                                                </select>
                                              </div>
                                            </div>
