...
<sidebar class="col-md-3 ">
             ...
             <nav class="row sidebar-menus">
                  <ul>
                        <a href="<?php echo e(url('/home')); ?>"><li  class="menuactive"><span class="glyphicon glyphicon-inbox">&nbsp;</span>Dashboard</li></a>
  ...
  <div class="col-md-12 content-panel-header">
            ...
            <div class="col-md-10" >
                      <div class="content-panel-status col-md-12">
                               ...
                               <img src="images/user.png">
                                  ...
                                  <p><?php echo $value->activity; ?> <a href="" data-toggle="modal" data-target="#newsfeed_<?php echo e($value->id); ?>"><span>check it here.</span></a></p>
            ...
            <!-- Modal for newsFeed -->
                                      <section>
                                                 ...
                                                 <div class="modal fade" id="newsfeed_<?php echo e($value->id); ?>" role="dialog">
                                                  <div class="modal-dialog">
                                                  
                                                    <!-- Modal content-->
                                                    <div class="modal-content">

                                                    <form method="" action="resume/deleteSkill/<?php echo e($value->id); ?>" class="theme1">
