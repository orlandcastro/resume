...
<sidebar class="col-md-3 ">
              ...
              <nav class="row sidebar-menus">
                  <ul>
                        ...
                        <?php } ?>   
                        <a href="<?php echo e(url('/profile')); ?>"><li class="menuactive"><span class="glyphicon glyphicon-star">&nbsp;</span>Profile</li></a>
    ...
    <section class="theme1">
          <section>
                    ...
                    <div class="col-md-12  content-panel">                 
                               ...
                               <div class="col-md-9">
                                <?php if ($if_exist == 1) { ?> 
                                        <input type="text" name="name" class="form-control" value="<?php echo e($userProfile->name); ?>">
                                <?php }else{ ?>
                   ...
                   <div class="col-md-12  content-panel">
                               ...
                               <div class="col-md-9">
                                <?php if ($if_exist == 1) { ?> 
                                        <input type="text" name="jobtitle" class="form-control" value="<?php echo e($userProfile->position); ?>">  
                                <?php }else{ ?>
                   ...
                   <div class="col-md-12  content-panel">
                               ...
                               <div class="col-md-9">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                         <input type="text" name="bday" class="form-control" value="<?php echo e($userProfile->bday); ?>"> 
                                <?php }else{ ?>
                   ...
                   <div class="col-md-12  content-panel">
                               ...
                               <div class="col-md-9">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                         <input type="text" name="address"  class="form-control" value="<?php echo e($userProfile->address); ?>"> 
                                <?php }else{ ?>
                   ...
                   <div class="col-md-12  content-panel">
                               ...
                               <div class="col-md-9">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                         <input type="email" name="email" class="form-control" value="<?php echo e($userProfile->email); ?>">
                                <?php }else{ ?>
                    ...
                    <div class="col-md-12  content-panel">
                               ...
                               <div class="col-md-9">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                        <input type="text" name="phone" class="form-control" value="<?php echo e($userProfile->phone); ?>">  
                                <?php }else{ ?>
            ...
            <section>
                      ...
                      <div class="col-md-12  content-panel">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                         <input type="text" name="facebook" class="form-control" value="<?php echo e($userProfile->facebook); ?>">  
                                <?php }else{ ?>
                     ...
                     <div class="col-md-12  content-panel">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                         <input type="text" name="linkedin" class="form-control" value="<?php echo e($userProfile->linkedin); ?>">  
                                <?php }else{ ?>
                    ...
                    <div class="col-md-12  content-panel">
                                ...
                                <?php if ($if_exist == 1) { ?> 
                                        <input type="text" name="twitter" class="form-control" value="<?php echo e($userProfile->twitter); ?>">  
                                <?php }else{ ?>
                      ...
                      <div class="col-md-12  content-panel">
                                 ...
                                 <div class="col-md-9">
                                    ...
                                    <?php if ($if_exist == 1) { ?> 
                                        <input type="text"  name="google" class="form-control" value="<?php echo e($userProfile->google); ?>">
                                <?php }else{ ?>
