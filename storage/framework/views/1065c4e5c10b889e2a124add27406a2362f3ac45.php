             ...
             <div class="row">
              ...
              <nav class="row sidebar-menus">
                  <ul>
                        ...
                        <a href="<?php echo e(url('/setting')); ?>"><li class="menuactive"><span class="glyphicon glyphicon-cog">&nbsp;</span>Settings</li></a>
...
<section>
         ...
         <div class="col-md-12  content-panel">
                     ...
                     <?php if ($if_exist_settings == 0) { ?>
                               <p>Not Set</p>
                      <?php }else{?> 
                               <p><?php echo e($userSettings->permalink); ?></p>
                      <?php } ?>                     
         ...
         <div class="col-md-12  content-panel">
                     ...
                     <div class="col-md-9">
                      ...
                      <?php }else{?>
                             <p><code><?php echo e($userSettings->preview); ?></code></p>   
                      <?php } ?>                   
          ...
          <div class="col-md-12  content-panel">
                     ...
                     <div class="col-md-9">
                      <?php if ($if_exist_settings == 0) { ?>
                            <p>Not Set</p>
                      <?php }else{?>
                             <p><?php echo e($userSettings->key); ?></p>   
                      <?php } ?>                
 ...
 <?php echo e(csrf_field()); ?>
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group form-group">
                                              <div class="col-md-offset-1 col-sm-10">
                                               <?php if ($if_exist_settings == 0) { ?>
                                                 <input class="form-control" name="username" type="text" value="<?php echo e($email); ?>">
                                                <?php }else{?>
                                                 <input class="form-control" name="username" type="text" value="<?php echo e($userSettings->username); ?>">     
                                                <?php } ?>  
                                              </div>
                                            </div>
                                             ...
                                             <div class="form-group form-group">
                                              <div class="col-md-offset-1 col-sm-10">
                                                ...
                                                <?php }else{?>
                                                 <input class="form-control" name="cv_link" type="text" value="<?php echo e($userSettings->permalink); ?>">
                                                <?php } ?>
                                              </div>
                                            </div>
                                            ...
                                            <div class="form-group form-group">
                                              ...
                                              <?php }else{?>
                                               <textarea class="form-control" name="embeded_code" rows="5" cols="10"><?php echo e($userSettings->preview); ?>
                                              ...
                                              <?php }else{?>
                                               <input class="form-control" name="token_key" type="text" value="<?php echo e($userSettings->key); ?>">
                                              <?php } ?>
